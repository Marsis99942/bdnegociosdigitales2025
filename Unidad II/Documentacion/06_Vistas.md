...
having count(*)>2
 ...
 /* Muestra los pedidos con informaci�n del cliente y el representante que los gestion�.*/
...
--Muestra cu�ntos pedidos ha gestionado cada representante y el total de ventas.
...
--Muestra el total de compras de cada cliente y si ha superado su l�mite de cr�dito.
...
--Muestra los productos que a�n no han sido vendidos en ning�n pedido.
...
--Muestra los pedidos donde el total del pedido es mayor al l�mite de cr�dito del cliente.
...
--Lista los productos con m�s unidades vendidas en total.
